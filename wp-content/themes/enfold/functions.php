...
if(!function_exists('avia_register_frontend_scripts'))
{
	...
	function avia_register_frontend_scripts()
	{
		...
		wp_enqueue_script( 'avia-default', $template_url.'/js/avia.js', array('jquery'), $vn, false );
		wp_enqueue_script( 'avia-shortcodes', $template_url.'/js/shortcodes.js', array('jquery','avia-default'), $vn, false );
